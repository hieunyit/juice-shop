pipeline {
  ...
  post {
    always {
      defectDojoPublisher artifact: 'gitleaks-report.json', autoCreateEngagements: false, autoCreateProducts: false, engagementId: '1', productId: '1', environment: '3', scanType: 'Gitleaks Scan'
